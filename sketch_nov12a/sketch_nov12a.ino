...
int coun1 = 0;
int look = 0;
int chk[16] = {0,100,260,385,482,530,587,630,660,688,714,735,753,769,784,800};// To set array comparision value


long irKeyCodes[16] = {0x00000000, 0x40BFF807, 0x40BF7887, 0xC03FC03F, 
//correspond to Keypad button '1', '2', '3','4' 0xC03F40BF,0x40BF00FF, 0x00000000, 0x00000000, 
//correspond to Keypad button'5', '6', '7','8'0x00000000, 0x00000000, 0x00000000, 0x00000000, 
//correspond to Keypad button'9', '10', '11,'12' 0x80FFC13E, 0x80FFE11E, 0x80FFD12E, 0x80FFF10E 
//correspond to Keypad button'13', '14', '15','16
};
...
void loop() {
sensorValue = random(1,16);// = analogRead(analogInPin); 
delay(15);
aaa:
if (FLAG == 0)
{
...
{
OK2 = 0; // if not, then OK=0 
}
OLDKEY = NEWKEY;
if(OK2>=5) // if OK =5 print the value
{
Serial.print("KEY = "); 
...
{
coun1=0;
irsend.sendNEC(irKeyCodes[NEWKEY], 26);
look++;
} 
if (sensorValue>950)
{
