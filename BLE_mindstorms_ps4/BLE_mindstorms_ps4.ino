...
int CH0_RED_OLD = 100;
int CH0_BLUE = 100;
int CH0_BLUE_OLD = 100;
int CH3_RED = 100;
int CH3_RED_OLD = 100;
int CH3_BLUE = 100;
int CH3_BLUE_OLD = 100;
...
void loop() {
  ...
  if (connected && BLEMode == true) {
    ...
    pRemoteCharacteristic->writeValue(inputValues, 9);
  ...
  else if (connected && BLEMode == false)
  {
    ...
    if (left_stick_x >= 108)
      ...
      CH0_RED = PWM_FWD7;
    //now compare
    //if (CH0_RED != CH0_RED_OLD)
    {
      pf.single_pwm(RED, CH0_RED);
    }
    //set value
    CH0_RED_OLD = CH0_RED;
    ...
    //if (CH0_BLUE != CH0_BLUE_OLD)
    {
      pf.single_pwm(BLUE, CH0_BLUE);
    }
    //set value
    CH0_BLUE_OLD = CH0_BLUE;
    ...
    //if (CH3_RED != CH3_RED_OLD)
    {
      pf_channel_4.single_pwm(RED, CH3_RED);
    }
    //set value
    CH3_RED_OLD = CH3_RED;
    ...
    //if (CH3_BLUE != CH3_BLUE_OLD)
    {
      pf_channel_4.single_pwm(BLUE, CH3_BLUE);
    }
    //set value
    CH3_BLUE_OLD = CH3_BLUE;

  }
  else if (doScan) {
    BLEDevice::getScan()->start(0);  // this is just example to start scan after disconnect, most likely there is better way to do it in arduino
  }
  delay(30); // Delay a second between loops.
  //delay(50); //=20Hz
} // End of loop
