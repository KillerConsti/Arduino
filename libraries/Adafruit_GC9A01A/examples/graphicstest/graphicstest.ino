...
#define kc_test_green_ DARKGREEN int(11/255*82048) + int(206/255100/432)+ int(0/8)
...
tft.fillRect(60, 0, 240, 180, kc_dirty_white);
...
unsigned long testText() {
  ...
  tft.color
  /* start here*/
  tft.fillCircle(60, 100, 25,kc_bluish );
  tft.fillCircle(160, 100, 25,kc_bluish );
  //tft.drawRect(60, 85, 100, 30, GC9A01A_GREEN);
  tft.fillRect(60, 85, 100, 50, kc_bluish);
