...
//extra font
#include <C:\Users\49151\Documents\Arduino\FeatureDemo_teensy_first_tries\Open_Sans_ExtraBold_16.h>
...
SMARTMATRIX_ALLOCATE_INDEXED_LAYER(indexedLayer_small, kMatrixWidth, kMatrixHeight, COLOR_DEPTH, kIndexedLayerOptions);
SMARTMATRIX_ALLOCATE_GFX_MONO_LAYER(indexedLayer_big, kMatrixWidth, kMatrixHeight, kMatrixWidth*3, kMatrixHeight, COLOR_DEPTH, kScrollingLayerOptions);
...
void setup() {
  ...
  matrix.addLayer(&indexedLayer_small); 
    matrix.addLayer(&indexedLayer_big); 
...
void loop() {
 const rgb24 blackBackground = {0, 0, 0};
    backgroundLayer.fillScreen(blackBackground);
  const rgb24 red = {255, 0, 0};
   backgroundLayer.drawRectangle(0, 0, 64, 32, red);
        indexedLayer.setFont(font5x7);
        indexedLayer.setIndexedColor(1, {0xff, 0xff, 0xff});
        indexedLayer.fillScreen(0);
        indexedLayer.drawString(2, 3, 1, "Beachfreunde");

        indexedLayer_big.setFont(gohufont11b);
        indexedLayer_big.setIndexedColor(2, {0x125, 0x0, 0xff});
        indexedLayer_big.drawString(50, 12, 2, "01");
        indexedLayer_small.setFont(font5x7);
        indexedLayer_small.setIndexedColor(2, {0x125, 0x0, 0xff});
        indexedLayer_small.drawString(10, 20, 2, "0");
        indexedLayer_small.swapBuffers();

        backgroundLayer.swapBuffers();
        indexedLayer.swapBuffers();
        indexedLayer_big.swapBuffers();
    delay(1000);
}
...
void doStuff()
{
    ...
    backgroundLayer.drawRectangle(0, 0, 64, 80, defaultBackgroundColor);
